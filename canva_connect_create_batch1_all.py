...
OUT_PATH = BASE / 'canva-batch1-created-designs.json'
...
def title_from_filename(filename):
    ...
    text = stem.replace('-', ' ').title()
    return f"NamEngine Batch 1 - {text}"
...
def main():
    ...
    for filename in FILES:
        ...
        token, asset_id, upload_job = upload_asset(token, path, title)
