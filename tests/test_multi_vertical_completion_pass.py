...
class MultiVerticalCompletionPassTest(unittest.TestCase):
        ...
        for vertical, phrases in expected.items():
            with self.subTest(vertical=vertical):
                ...
                if vertical == "baby":
                    ...
                    self.assertNotIn("Step 1 of 3", body)
                self.assertIn("baby-intake-polish.js?v=20260823-other-trigger-v1", body)
    ...
    def test_launch_navigation_is_minimal_and_unfinished_routes_remain_available(self):
        ...
        self.assertIn('href="/about"', flow_header)
        self.assertIn('href="/business"', flow_header)
        self.assertNotIn('href="/privacy"', flow_header)
