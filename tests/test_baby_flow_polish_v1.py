...
class BabyFlowPolishV1Test(unittest.TestCase):
    ...
    def test_baby_progress_and_saved_state_have_frontend_contracts(self):
        ...
        self.assertIn("Bringing together everything you shared", progress)
        self.assertIn("Exploring names that fit your style", progress)
        self.assertIn("Looking at meaning, feeling, and family fit", progress)
        self.assertIn("Finding names worth considering", progress)
