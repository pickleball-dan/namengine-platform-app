...
class BabyFlowPolishV1Test(unittest.TestCase):
    ...
    def test_baby_intake_keeps_questions_and_trust_contract(self):
        ...
        self.assertIn("Step 3 of 3", body)
    ...
    def test_baby_results_emphasize_understanding_names_and_saves(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn("Based on everything you shared", body)
        self.assertIn("baby-saved-progress", body)
        self.assertIn("Saved 0 names", body)
    ...
    def test_baby_progress_and_saved_state_have_frontend_contracts(self):
        ...
        self.assertIn("Studying your family's naming style", progress)
        self.assertIn("Balancing uniqueness and familiarity", progress)
        self.assertIn("Finding names that simply feel right", progress)
