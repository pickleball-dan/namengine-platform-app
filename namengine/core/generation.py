...
BABY_HERITAGE_POOL = [
    ...
    ("Sakura", "sah-KOO-rah", "Japanese-rooted, floral, bright, and playful without feeling flimsy.", "japanese"),
    ("Hana", "HAH-nah", "Japanese-rooted and international, simple, floral, and warm.", "japanese"),
    ("Yumi", "YOO-mee", "Japanese-rooted, cheerful, compact, and easy to say.", "japanese"),
    ("Emi", "EH-mee", "Japanese-rooted, sweet, brief, and friendly.", "japanese"),
    ("Aiko", "EYE-koh", "Japanese-rooted, affectionate, bright, and distinctive.", "japanese"),
    ("Mei", "MAY", "Japanese-rooted in many uses, tiny, bright, and lively.", "japanese chinese"),
    ("Rina", "REE-nah", "Japanese-friendly, melodic, and familiar across cultures.", "japanese"),
    ("Kiko", "KEE-koh", "Japanese-rooted, stylish, playful, and compact.", "japanese"),
    ("Mika", "MEE-kah", "Japanese-rooted in many uses, bright, compact, and friendly.", "japanese native_american indigenous"),
    ("Noa", "NOH-ah", "Japanese-rooted in some uses, airy, modern, and gentle.", "japanese hebrew"),
    ("Yuna", "YOO-nah", "Japanese-rooted in many uses, soft, bright, and modern.", "japanese korean"),
    ("Hina", "HEE-nah", "Japanese-rooted, sunny, gentle, and easy to wear.", "japanese"),
    ("Sakura", "sah-KOO-rah", "Japanese-rooted, floral, bright, and playful without feeling flimsy.", "japanese"),
    ("Hana", "HAH-nah", "Japanese-rooted and international, simple, floral, and warm.", "japanese"),
    ("Yumi", "YOO-mee", "Japanese-rooted, cheerful, compact, and easy to say.", "japanese"),
    ("Emi", "EH-mee", "Japanese-rooted, sweet, brief, and friendly.", "japanese"),
