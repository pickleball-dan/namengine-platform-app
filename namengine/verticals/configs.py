...
BABY = VerticalConfig(
    ...
    intake_questions=(
        ...
        Question(
            "cultural_heritage",
            "Cultural / heritage feel",
            choices=BABY_CULTURAL_HERITAGE_OPTIONS,
            help_text="For Native American / Indigenous context, add the specific nation or community in notes if relevant.",
            section="About your baby",
        ),
        Question(
            "familiarity_preference",
...
BUSINESS = VerticalConfig(
    ...
    theme={
        ...
        "accent_deep": "#0d2540",
        "accent_pet": "#d9a441",
        "accent_soft": "rgba(63, 166, 160, 0.18)",
        "accent_warm_soft": "rgba(217, 164, 65, 0.18)",
        "surface": "rgba(245, 251, 250, 0.96)",
        "page": "#f3faf9",
        "card": "#ffffff",
        "ink": "#0d2540",
        "muted": "#536879",
    ...
    assets={
        ...
        "page_logo": "images/namengine-biz.svg",
    ...
    visual=VerticalVisualConfig(
        ...
        main_colors=("#0d2540", "#3fa6a0"),
        accent_colors=("#d9a441", "#f3faf9"),
...
BOAT = VerticalConfig(
    ...
    intake_questions=(
        Question(
            "boat_type",
            "What kind of vessel are you naming?",
            required=True,
        ...
        Question(
            "waters",
            "Where will you mostly take her?",
            choices=BOAT_WATERS_OPTIONS,
            section="About your vessel",
        ),
        Question(
            "crew",
            "Who's usually aboard?",
        ...
        Question(
            "vibe",
            "What personality should the name have?",
            required=True,
        ...
        Question(
            "inspiration",
            "Anything you'd love the name to draw from?",
            kind="textarea",
            placeholder="A person, place, memory, heritage, profession, hobby, saying, song, mythology…",
            section="Fit and feeling",
        ),
        Question(
            "avoid",
        ...
        Question(
            "notes",
            "When you imagine the perfect name on the stern, what would make it feel exactly right?",
            kind="textarea",
        ...
        Question(
            "loved_names",
            "Any boat names — or names in general — you already love?",
            kind="textarea",
            placeholder="Even names you'd never use. Tell us a few — it's some of the best taste signal we get.",
            section="Fit and feeling",
        ),
    ),
    prompt_context=(
