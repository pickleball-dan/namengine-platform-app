...
BABY = VerticalConfig(
    ...
    intake_questions=(
        ...
        Question(
            ...
            help_text="Optional. Choose No preference if culture or heritage should not guide the list. For Native American / Indigenous context, add the specific nation or community in notes if relevant.",
            section="About your baby",
        ),
        Question(
            "notes",
